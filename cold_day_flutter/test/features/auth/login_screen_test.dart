...
void main() {
  ...
  testWidgets(
      ...
      'NO entra a ningún flujo', (WidgetTester tester) async {
    ApiClient.setClient(FakeApiClient((request) {
    ...
    expect(
      find.text('Credenciales inválidas. Verificá tu documento y contraseña.'),
      findsOneWidget,
    );
